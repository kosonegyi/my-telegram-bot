import os
telefrom telegram import InlineKeyboardButton, InlineKeyboardMarkup
from
gram.ext import ApplicationBuilder, CommandHandler, CallbackQueryHandler
...
# Render Environment Variables ထဲတွင် TOKEN ရှိရပါမည်
TOKEN = os.getenv('8897020821:AAFYPCopRI84EzIK5GstAM99Edo5Pz0Sq18') 
