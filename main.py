...
# --- Render အတွက် Web Server ပြင်ဆင်ခြင်း ---
# Free Plan တွင် အိပ်မသွားစေရန်နှင့် Port configuration အဆင်ပြေစေရန် ဖြစ်သည်
flask_app = Flask('')
...
def run_flask():
    # Render သည် ၎င်းတို့ပေးသော PORT environment variable ကို သုံးရန် လိုအပ်သည်
...
async def button_click(update, context):
    ...
    if query.data == 'matches':
        ...
        await query.message.edit_text("💸 <b>ငွေသွင်း/ငွေထုတ်ရန်အတွက်</b> Admin <a href='https://t.me'>@kothu7877</a> ကို ဆက်သွယ်ပေးပါ။", parse_mode='HTML', reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔙 နောက်သို့", callback_data='start')]]))
    elif query.data == 'start':
        await query.message.edit_text(get_main_text(), parse_mode='HTML', reply_markup=InlineKeyboardMarkup(get_keyboard()))

if __name__ == '__main__':
    # Web Server ကို နောက်ကွယ်မှ စတင်နှိုးခြင်း
    keep_alive()
